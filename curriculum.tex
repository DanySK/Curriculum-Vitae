...
\begin{outerlist}
\item[] \textit{PhD Student} \hfill \textbf{from January 2012}
    \begin{innerlist}
    ...
    \end{innerlist}
\item[] \textit{Contract Researcher} \hfill \textbf{from June 2011 to December 2012}
    \begin{innerlist}
...
\begin{outerlist}
 \item[] \textit{Visiting Researcher} \hfill \textbf{from July 2009 to October 2009}
    \begin{innerlist}
...
\begin{outerlist}
\item[] \textit{Visiting Researcher} \hfill \textbf{July 2013, ongoing}
    \begin{innerlist}
