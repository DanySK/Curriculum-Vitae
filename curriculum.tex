...
Microbiology:
\begin{innerlist}
    \item In vitro cell cultures with agar-based substrates
    \item Colouring and counting techniques
    \item Microbiology laboratory tools usage (Microscope, incubator, autoclave...)
\end{innerlist}
\halfblankline

Chemistry and pharmaceutics:
\begin{innerlist}
    \item Sampling and quality control procedures
    \item Chemistry laboratory tools usage (pH Meter, Spectrophotometer, Granulometer...)
\end{innerlist}
\halfblankline
...
\begin{innerlist}
    ...
    \item Overclocking
    \item Water-circuit based cooling techniques
    \item TEC-based cooling technologies
\end{innerlist}
\halfblankline
...
\begin{innerlist}
    ...
    \item Linux installation and configuration for both desktop and server, with specific skills for Gentoo Linux and derivatives.
\end{innerlist}
\halfblankline

Computer Programming:
\begin{innerlist}
    \item Java, C, Python, C$+$$+$, Jason, Prolog, tuProlog, UNIX shell scripting, SQL, \Matlab, XText, Xtend, and others.
...
Operating Systems:
\begin{innerlist}
    \item Linux, BSD, and other UNIX variants, Microsoft Windows family
\end{innerlist}
\halfblankline
...
\begin{innerlist}
    ...
    \item 3D Programming (OpenGL, Java Monkey Engine)
\end{innerlist}
