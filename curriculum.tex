...
\immediate\write18{gem install --user-install bundler}
\immediate\write18{bundle install}
...
\begin{outerlist}
    \item Junior assistant professor (fixed-term)
\end{outerlist}
