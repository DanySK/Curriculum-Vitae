...
\item[] \textit{Post-doc} \hfill \textbf{since January 2015}
    \begin{innerlist}
      \item Co-Supervisor \href{http://amslaurea.unibo.it/14019/}{Giuacomo Scaparrotti's thesis: \textit{Studio delle prestazioni del simulatore Alchemist: ottimizzazione di routing e caching}}, 2017.
...
\section{Service}
\href{http://apice.unibo.it/xwiki/bin/view/ECAS2017/WebHome}{2nd eCAS Workshop on Engineering Collective Adaptive Systems (eCAS 2017)} \\ PC member \\
\halfblankline \\
...
\begin{innerlist}
    \item Java, Scala, C, Python, Prolog, Groovy, C$+$$+$, UNIX shell scripting, SQL, Xtend, and others.
