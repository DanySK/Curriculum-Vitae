...
Frequent contributor to \href{http://www.openstreetmap.org/}{OpenStreetMap}.
\begin{innerlist}
    \item Significant contributions in mapping roads and various reference points in the Montefeltro (Italy) area.
\end{innerlist}
\halfblankline
