...
\begin{outerlist}
    \item[2025/26]
        \unibocourse
        {https://archive.is/yauGp}{Software Process Engineering}
        {https://archive.is/hCoiW}{Two year master in Computer Science and Engineering (Laurea magistrale in Ingegneria e Scienze informatiche)}
        {3 CFU/ECTS, 30 hours, $\sim$30 students}
        {(92.0\%, 100.0\%, 100.0\%, 100.0\%, 25)}
    ...
    \item[2025/26]
        \unibocourse
        {https://archive.is/FaKeL}{Software Design and Development (Progettazione e Sviluppo del Software)}
        {https://archive.is/QD1mo}{First cycle degree programme in Computer Systems Technologies (Laurea in Tecnologie dei sistemi informatici)}
        {3 CFU/ECTS, 30 hours, $\sim$20 students}
        {(75.0\%, 100.0\%, 100.0\%, 100.0\%, 12)}
        {Object Oriented design and programming in Java. Build systems. Version control.}
    \item[2024/25]
        \unibocourse
...
\begin{outerlist}
    \item[2025/26]
        \unibocourse
        {https://archive.is/9VLb9}{Micro-Macro Computational Models: Theory, Applications and Emergent Properties}
        {https://archive.is/hFA8Z}{Collegio Superiore}
        {1.2 CFU/ECTS, 8 hours, $\sim$6 students}
        {(83.3\%, 100\%, 100\%, 100\%, 6)}
        {\oopjava}
    \item[2025/26]
        \unibocourse
        {https://archive.is/1OdRO}{Object-Oriented Programming (Programmazione ad Oggetti)}
        {https://archive.is/gpt1w}{Bachelor in Computer Science and Engineering (Laurea in Ingegneria e scienze informatiche)}
        {3 CFU/ECTS, 30 hours, $\sim$150 students}
        {(88.5\%, 98.1\%, 84.5\%, 91.2\%, 104)}
        {\oopjava}
    \item[2024/25]
        \unibocourse
...
\vspace{-1em}
\begin{innerlist}
    \item Filippo Gurioli: \href{https://amslaurea.unibo.it/38087/}{\textit{Lowering the Reality Gap in Aggregate Programs Validation: Running Collektive Over Unity}}, 2026.
...
\vspace{-1em}
\begin{innerlist}
    \item Lorenzo Antonioli: \href{https://amslaurea.unibo.it/39349/}{\textit{Analisi dell'impiego di SOG e COG in algoritmi di clustering per reti marittime}}, 2026.
    \item Andrea Cecchini: \href{https://amslaurea.unibo.it/37130/}{\textit{Da MIT Proto a Collektive: Trasposizione di esempi di programmazione aggregata in un DSL in Kotlin}}, 2025.
    \item Simone Magnani: \href{https://amslaurea.unibo.it/36195/}{\textit{Caratterizzazione dell'impatto sulle prestazioni di sistemi di virtualizzazione in macchine per la manifattura}}, 2025.
