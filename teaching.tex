...
\section{Responsibility of master courses}
\vspace{-2em}
\begin{outerlist}
    \item[2020/21]
        \unibocourse
        {https://archive.is/CyIjt}{Laboratory of Software Systems}
        {https://archive.is/Svmye}{Master in Computer Science and Engineering}
        {3 CFU/ECTS}
        {(96\%, 96\%, 95.8\%, 100\%, 25)}
...
\begin{outerlist}
    \item[2020/21]
        \unibocourse
        {https://archive.is/WxwNn}{Object-Oriented Programming}
        {https://archive.is/WeNI1}{Bachelor in Computer Science and Engineering}
        {3 CFU/ECTS}
        {(77.7\%, 96.4\%, 79.5\%, 79.5\%, 112)}
        {Practical OOP programming in Java from simple examples to advanced mechanisms and design patterns, including parallel and functional-like programming; basics of quality assurance, profiling, and build automation; distributed version control.}
    \item[2019/20]
        \unibocourse
        {http://archive.fo/JtEDW}{Object-Oriented Programming}
        {http://archive.fo/UM5wl}{Bachelor in Computer Science and Engineering}
        {3 CFU/ECTS}
    ...
    \item[2018/19]
        ...
        {Practical OOP programming in Java from simple examples to advanced mechanisms and design patterns, including parallel and functional-like programming; basics of quality assurance and profiling; distributed version control.}
    \item[2017/18]
        \unibocourse
        {http://archive.fo/54lT9}{Object-Oriented Programming}
        {http://archive.fo/UM5wl}{Bachelor in Computer Science and Engineering}
        {3 CFU/ECTS}
    ...
    \item[2016/17]
        \unibocourse
        {http://archive.fo/0XLbd}{Object-Oriented Programming}
        {http://archive.fo/UM5wl}{Bachelor in Computer Science and Engineering}
        {3 CFU/ECTS}
    ...
    \item[2015/16]
        \unibocourse
        {http://archive.fo/1eIMt}{Engineering Complex Adaptive Software Systems}
    ...
    \item[2014/15]
        \unibocourse
        {http://archive.fo/JrWEu/}{Foundations of Informatics A}
        {http://archive.fo/30rN0}{Bachelor in Electronics Engineering for Energy and Information}
        {3 CFU/ECTS}
    ...
    \item[2014/15]
        \unibocourse
        {http://archive.fo/JrWEu/}{Foundations of Informatics A}
        {http://archive.fo/jW52L}{Bachelor in Biomedical Engineering}
        {3 CFU/ECTS}
        {(88.7\%, 95.1\%, 98.4\%, 98.4\%, 62)}
        {Practical imperative programming in C, from foundations to graphical interfaces.}
    \item[2011/12]
        \unibocourse
        {http://archive.fo/nnsBl/}{Multi-Agent Systems}
        {http://archive.fo/qDVq3}{Two-year master in Computer Engineering}
        {3 CFU/ECTS}
        {(90.9\%, 100\%, 100\%, 100\%, 11)}
...
\begin{outerlist}
    ...
    \item[2013/14]
        ...
        {http://archive.fo/UM5wl}{Bachelor in Electronics Engineering for Energy and Information, Bachelor in Biomedical Engineering}.
\end{outerlist}
