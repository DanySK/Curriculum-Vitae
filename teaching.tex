...
\begin{outerlist}
    \item[2021/22]
        \unibocourse
        {https://archive.ph/75yeO}{Laboratory of Software Systems}
        {https://archive.ph/ljEQn}{Two year master in Computer Science and Engineering}
        {3 CFU/ECTS}
        {(evaluations to be communicated yet)}
    ...
    \item[2020/21]
        ...
        {https://archive.is/Svmye}{Two year master in Computer Science and Engineering}
        {3 CFU/ECTS}
        {(96\%, 96\%, 95.8\%, 100\%, 25)}
        {Internal DSLs in Kotlin and their use in build systems, DevOps practices, build automation (Gradle as paradigmatic automator), continuous integration, advanced version control and team organization, licensing, open source sharing.}
\end{outerlist}
...
\begin{outerlist}
    ...
    \item[2021/22]
        \unibocourse
        {https://archive.ph/oUCdx}{Object-Oriented Programming}
        {https://archive.ph/vKgXj}{Bachelor in Computer Science and Engineering}
        {3 CFU/ECTS}
        {(evaluations to be communicated yet)}
        {\oopjava}
    \item[2020/21]
